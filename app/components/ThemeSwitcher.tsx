...
export default function ThemeSwitcher() {
  ...
  const applyTheme = (colorName: string) => {
    ...
    if (rgb && rgb.length >= 3) {
      ...
      // Update globe colors based on theme mode
      if (isDark) {
        // Dark mode: Update all globe colors with theme
        ...
        // Make glow more subtle (30% of original intensity)
        ...
        // Light mode: Keep base white, markers dynamic with theme, glow white (fixed)
