      ...
      dropdownItems: [
        {
          title: 'About Us',
          url: '/company/about',
          icon: <Building className="w-8 h-8 text-[#28a745]" />,
          description: "Learn about our story and mission"
        },
        {
          title: 'Contact Us',
          url: '/company/contact',
          icon: <Mail className="w-8 h-8 text-[#28a745]" />,
          description: "Get in touch with our team"
        },
        {
          title: 'Terms of Service',
          url: '/company/terms',
          icon: <Scale className="w-8 h-8 text-[#28a745]" />,
          description: "Our service terms and conditions"
        },
        {
          title: 'Privacy Policy',
          url: '/company/privacy',
          icon: <Lock className="w-8 h-8 text-[#28a745]" />,
          description: "How we protect your data"
        },
        {
          title: 'Cookie Policy',
          url: '/company/cookies',
          icon: <Cookie className="w-8 h-8 text-[#28a745]" />,
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50">
      ...
      <div className={`w-full transition-all duration-300 ${
        isScrolled 
          ? 'bg-[#000000]' 
          : 'bg-[#000000]/100 backdrop-blur-sm shadow-lg border-b border-[#28a745]/10'
      }`}>
        <div className="w-full mx-auto flex items-center justify-between px-4 sm:px-6 py-4">
          ...
          <div className="flex items-center space-x-4 sm:space-x-8">
            ...
            <Link href="/" className="group flex items-center">
              <h1 className="text-[#28a745] text-2xl sm:text-3xl font-bold tracking-tight group-hover:text-white transition-all duration-300 transform group-hover:scale-105">
                OozeCloud
              </h1>
            </Link>
            ...
            <div className="hidden lg:flex items-center space-x-6">
              <div className="flex items-center space-x-2 px-4 py-1 bg-[#28a745]/10 rounded-full">
            ...
            <div className="hidden md:flex items-center space-x-1">
              {navItems.map((item) => (
                ...
                >
                  <Link
                    href={item.url}
                    className="px-4 py-2 text-white hover:text-[#28a745] transition-colors duration-200 flex items-center space-x-1 group nav-link"
                    onClick={(e) => {
                      if (item.hasDropdown) {
                        e.preventDefault();
                  ...
                  {item.hasDropdown && activeDropdown === item.title && (
                    <div 
                      className={`absolute mt-0 bg-[#0B0E14] border border-[#28a745]/10 rounded-lg shadow-xl ${
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          {item.dropdownItems?.map((dropdownItem) => (
                            <Link
                              ...
                              className="block p-4 text-white hover:bg-[#28a745]/5 transition-all duration-200 rounded-lg border border-[#28a745]/5"
                              ...
                              <div className="flex items-center space-x-4">
                                <div className="w-12 h-12 flex items-center justify-center">
                                  ...
                                  {dropdownItem.title === 'Other Games' && (
                                    <div className="w-12 h-12 flex items-center justify-center text-[#28a745]">
                                      <svg 
                                        className="w-8 h-8" 
                                        viewBox="0 0 24 24" 
                                        fill="none" 
                        ...
                        <div className="py-2">
                          {item.dropdownItems?.map((dropdownItem) => (
                            <Link
                              key={dropdownItem.title}
                              href={dropdownItem.url}
                              className="block px-6 py-4 text-white hover:bg-[#28a745]/5 transition-all duration-200 first:rounded-t-lg last:rounded-b-lg border-b border-[#28a745]/5 last:border-b-0"
                              onClick={handleLinkClick}
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-4">
                                  {dropdownItem.title === 'Web Hosting' ? (
                                    <svg className="w-6 h-6 text-[#28a745]" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        ...
                        <div className="py-2">
                          {item.dropdownItems?.map((dropdownItem) => (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-4">
                                  <div className="p-3 bg-[#28a745]/10 rounded-xl">
                                    {dropdownItem.icon}
                                  </div>
                                  <div>
                                    <span className="font-medium text-lg">{dropdownItem.title}</span>
                            ...
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-4">
                                {dropdownItem.title === 'Support' ? (
                                  <svg 
                                    className="w-6 h-6 text-[#28a745] shrink-0" 
                                    viewBox="0 0 24 24" 
                                    fill="none" 
                                    stroke="currentColor"
                                  >
                                  ...
                                  <svg 
                                    className="w-12 h-12 text-[#28a745] shrink-0" 
                                    viewBox="0 0 24 24" 
                                    fill="none" 
                                    stroke="currentColor"
                                  >
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link
              ...
              className="bg-black border border-[#28a745] hover:bg-[#28a745] text-[#28a745] hover:text-black px-6 py-2 rounded-lg text-sm font-medium transition-all duration-300 hover:shadow-lg hover:shadow-[#28a745]/20"
            >
              Dashboard
            </Link>
            <Link
          ...
          {/* Mobile Menu Button */}
          <button
            className="md:hidden text-gray-400 hover:text-[#28a745] transition-colors duration-300 mobile-menu-button"
        ...
        {/* Mobile Menu */}
        <div
          className={`mobile-menu md:hidden bg-[#0B0E14] border-t border-[#28a745]/10 overflow-hidden transition-all duration-300 ease-in-out ${
        ...
        >
          <div className="px-4 py-2 space-y-2 overflow-y-auto max-h-[calc(80vh-4rem)]">
            {navItems.map((item) => (
              <div key={item.title} className="border-b border-[#28a745]/10 last:border-b-0">
                <button
                  onClick={(e) => {
                    e.stopPropagation();
                    handleDropdownToggle(activeDropdown === item.title ? null : item.title, e);
                  }}
                  className="w-full flex items-center justify-between px-4 py-3 text-white hover:text-[#28a745] transition-colors duration-200"
                >
                  ...
                  <div className="bg-[#0B0E14]/50 py-2">
                    {item.dropdownItems?.map((dropdownItem) => (
                      <Link
                        ...
                        className="block px-8 py-3 text-gray-300 hover:text-white hover:bg-[#28a745]/5 transition-all duration-200"
                      >
            ...
            {/* Mobile Menu Buttons */}
            <div className="grid grid-cols-2 gap-4 px-4 py-4 border-t border-[#28a745]/10">
              <Link
                href="/login"
                onClick={(e) => {
                  e.stopPropagation();
                ...
                className="bg-black border border-[#28a745] hover:bg-[#28a745] text-[#28a745] hover:text-black px-4 py-2 rounded-lg text-center text-sm font-medium transition-all duration-300"
              >
                Dashboard
              </Link>
              <Link
