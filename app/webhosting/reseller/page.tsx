...
const features: BentoItem[] = [
  {
    ...
    icon: <DollarSign className="w-5 h-5 text-[#fbbf24]" />,
    status: "Premium",
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative overflow-hidden bg-black pt-20 md:pt-32 pb-16 md:pb-20">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-radial from-[#fbbf24]/20 via-black to-black"></div>
          <div className="absolute inset-0">
            {Array.from({ length: 30 }).map((_, i) => (
              ...
              >
                <div className="w-2 h-2 bg-[#fbbf24]/20 rounded-full blur-sm"></div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1 text-center lg:text-left">
              <motion.div
                ...
                className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-[#fbbf24]/20 to-[#f59e0b]/20 text-[#fbbf24] text-sm font-medium mb-6"
              >
              ...
              >
                ...
                <span className="relative block mt-2">
                  <span className="relative z-10 bg-gradient-to-r from-[#fbbf24] to-[#f59e0b] text-transparent bg-clip-text">
                    Hosting Empire
                  </span>
                  <span className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-[#fbbf24]/20 to-[#f59e0b]/20 rounded-full blur-lg"></span>
                </span>
              </motion.h1>
                ...
                {[
                  ...
                  <div key={index} className="relative group">
                    ...
                    <div className="relative text-center p-4">
                      <div className="text-[#fbbf24] mb-2 flex justify-center">{stat.icon}</div>
            ...
            >
              <div className="relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-[#fbbf24] to-[#f59e0b] rounded-2xl opacity-20 blur"></div>
                  ...
                  <div className="p-6 font-mono text-sm">
                    <div className="space-y-3">
                      ...
                      <div className="pl-4 space-y-2">
                        ...
                        <div className="flex items-center text-[#fbbf24] animate-pulse">
                  ...
                  <div className="bg-black/50 backdrop-blur-xl p-4 border-t border-gray-800/50">
                    <div className="space-y-2">
                      ...
                      <div className="h-1.5 bg-gray-800 rounded-full overflow-hidden">
                        <div className="h-full bg-gradient-to-r from-[#fbbf24] to-[#f59e0b] w-[75%] rounded-full"></div>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-black via-[#fbbf24]/5 to-black"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 relative">
          <div className="text-center mb-16">
            ...
            >
              ...
              <span className="text-[#fbbf24]"> Succeed</span>
            </motion.h2>
          ...
          <div className="relative">
            <div className="absolute inset-y-0 left-0 flex items-center">
              <button
                ...
                className="p-2 rounded-full bg-[#fbbf24]/10 text-[#fbbf24] hover:bg-[#fbbf24]/20 transition-colors"
              >
                ...
                {features.map((feature, index) => (
                  <div key={index} className="w-full flex-shrink-0 px-4">
                    <motion.div
                      ...
                      whileInView={{ opacity: 1, y: 0 }}
                      transition={{ duration: 0.5 }}
                      className="bg-gradient-to-b from-[#fbbf24]/10 to-transparent backdrop-blur-xl rounded-2xl p-8 border border-[#fbbf24]/20"
                    >
                      <div className="flex items-start gap-4">
                        <div className="p-3 rounded-lg bg-[#fbbf24]/20">
                          {feature.icon}
                        </div>
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-4">
                            {feature.tags?.map((tag, tagIndex) => (
                              <span
                                key={tagIndex}
                                className="px-2 py-1 text-xs rounded-full bg-[#fbbf24]/10 text-[#fbbf24]"
                              >
                                {tag}
                              </span>
                            ))}
            ...
            {features.map((_, index) => (
              <button
                ...
                className={`w-2 h-2 rounded-full transition-colors ${
                  activeFeature === index ? 'bg-[#fbbf24]' : 'bg-[#fbbf24]/20'
                }`}
              />
            ))}
          </div>
      ...
      <div id="pricing-section" className="py-16 md:py-24 bg-black relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-tr from-[#fbbf24]/10 via-transparent to-transparent"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-16">
            ...
            >
              Choose Your
              <span className="text-[#fbbf24]"> Business Plan</span>
            </motion.h2>
          ...
          >
            <span className={`text-sm font-medium ${billingPeriod === 'monthly' ? 'text-[#fbbf24]' : 'text-gray-400'}`}>
              Monthly
            </span>
            <button
            ...
            <div className="flex items-center">
              <span className={`text-sm font-medium ${billingPeriod === 'yearly' ? 'text-[#fbbf24]' : 'text-gray-400'}`}>
                Yearly
              </span>
              <span className="ml-2 inline-flex items-center px-2 py-1 rounded-full bg-[#fbbf24]/10 text-[#fbbf24] text-xs font-medium">
                Save 20%
              </span>
            </div>
          </motion.div>
              ...
              >
                {plan.isPopular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <div className="bg-[#fbbf24] text-black text-sm font-medium px-4 py-1 rounded-full">
                      Most Popular
                    </div>
                  </div>
                )}
                  ...
                  <ul className="space-y-4 mb-8">
                    {plan.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center text-sm">
                        <svg className="w-5 h-5 text-[#fbbf24] mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                        </svg>
