  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#0f1117] flex items-center justify-center">
        <div className="animate-spin w-8 h-8 border-2 border-[#28a745] border-t-transparent rounded-full"></div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#0f1117] text-white relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 h-screen flex flex-col items-center justify-center">
        ...
        <div className="relative mb-8">
          ...
          <h1 className="text-[8rem] md:text-[12rem] font-bold leading-none tracking-tighter">
            ...
            <span className="absolute -left-[1px] -top-[1px] text-[#28a745] opacity-70 animate-glitch-2">{glitchText}</span>
        ...
        <div className="text-center space-y-6 max-w-xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-8">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-[#28a745] to-orange-500 rounded-lg opacity-70 group-hover:opacity-100 transition-opacity"></div>
            ...
            <button
              ...
              className="group relative px-6 py-3 w-full sm:w-auto text-center"
            >
              <div className="absolute inset-0 border border-[#28a745]/30 rounded-lg group-hover:border-[#28a745]/60 transition-colors"></div>
              <span className="relative text-[#28a745] font-medium">Go Back</span>
            </button>
          </div>
        </div>

        {/* Decorative Elements */}
        <div className="absolute left-0 right-0 bottom-0 h-px bg-gradient-to-r from-transparent via-[#28a745]/20 to-transparent"></div>
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none">
        {Array.from({ length: 20 }).map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-[#28a745] rounded-full"
            style={{
