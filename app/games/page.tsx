    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900">
      ...
      <div className="relative pt-24 pb-16 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          <div className="relative z-10 text-center">
            <h1 className="text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#fbbf24] via-orange-500 to-[#fbbf24] mb-6 tracking-tight">
              Game Servers
            </h1>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              <div className="bg-black/30 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <div className="text-3xl font-bold text-[#fbbf24] mb-2">{baseGames.length}+</div>
                <div className="text-gray-400">Games Available</div>
              </div>
              <div className="bg-black/30 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <div className="text-3xl font-bold text-[#fbbf24] mb-2">99.9%</div>
                <div className="text-gray-400">Uptime</div>
              </div>
              <div className="bg-black/30 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <div className="text-3xl font-bold text-[#fbbf24] mb-2">24/7</div>
                <div className="text-gray-400">Support</div>
              </div>
              <div className="bg-black/30 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                <div className="text-3xl font-bold text-[#fbbf24] mb-2">1-Click</div>
      ...
      <div className="max-w-7xl mx-auto px-4 mb-12">
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-[#fbbf24]/10 to-orange-500/10 rounded-2xl blur-xl"></div>
                ...
                <div className="flex-1">
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-5 py-4 bg-black/30 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:ring-2 focus:ring-[#fbbf24] focus:border-transparent transition-all"
                      value={searchQuery}
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${
                          selectedCategory === null
                            ? 'bg-gradient-to-r from-[#fbbf24] to-orange-500 text-black shadow-lg shadow-orange-500/20'
                  ...
                  <div className="md:col-span-5">
                    ...
                    <div className="px-4">
                      <input
                        ...
                        className="w-full h-2 bg-black/30 rounded-lg appearance-none cursor-pointer accent-[#fbbf24]"
                      />
        ...
        {filteredGames.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredGames.map((game) => (
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-[#fbbf24]/20 to-orange-500/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                <div className="relative bg-gray-900/40 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden hover:border-[#fbbf24]/50 transition-all duration-300 flex flex-col flex-1">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {game.categories.map((category) => (
                        <span key={category} className="px-3 py-1 bg-gradient-to-r from-[#fbbf24]/10 to-orange-500/10 text-[#fbbf24] text-sm rounded-full border border-[#fbbf24]/20">
                    ...
                    <ul className="space-y-2 mb-6 flex-1">
                      {game.features.map((feature) => (
                        <li key={feature} className="flex items-center text-gray-400">
                          <svg className="w-5 h-5 text-[#fbbf24] mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <Link
                      ...
                      className="block w-full text-center bg-gradient-to-r from-[#fbbf24] to-orange-500 text-black font-semibold py-3 px-4 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/20 hover:-translate-y-0.5 mt-auto"
                    >
                      View Details
                    </Link>
                  </div>
