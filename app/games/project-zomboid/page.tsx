...
export default function ProjectZomboid() {
    ...
    return [
      {
        ...
        description: "Perfect for small survival groups up to 10 players",
      ...
      },
      {
        ...
        description: "Ideal for medium-sized communities with up to 32 players",
        buttonText: "Deploy Now",
        href: "/deploy",
        isPopular: true,
      },
      {
        name: "ENTERPRISE ZOMBOID",
        ...
        description: "For large survival communities with 64+ players",
        buttonText: "Deploy Now",
        href: "/deploy",
        isPopular: false,
      }
              ...
              className={`relative group p-6 rounded-xl border-2 transition-all duration-300 min-w-[200px] ${
                isOutOfStock 
                  ...
                  : selectedCountry === code
                    ...
                    : 'border-gray-800 hover:border-[#c41e3a]/50 hover:bg-[#c41e3a]/5'
              }`}
            >
              <div className="flex flex-col items-center">
                ...
                {selectedCountry === code && !isOutOfStock && (
                  <div className="absolute -top-3 -right-3">
                    <div className="w-6 h-6 bg-[#c41e3a] rounded-full flex items-center justify-center">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-[#1a1d26] to-[#0f1117] pt-32 pb-20 min-h-[800px]">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute inset-0 w-full h-full">
            <iframe
              src="https://www.youtube.com/embed/nPbsDmzZ3Oc?autoplay=1&mute=1&controls=0&loop=1&playlist=nPbsDmzZ3Oc&showinfo=0&modestbranding=1&rel=0"
        ...
        <div className="relative max-w-6xl mx-auto text-center px-4 z-20 mt-12">
          <div className="animate-fade-in-up backdrop-blur-sm bg-black/10 p-12 rounded-3xl">
            <h1 className="text-7xl font-bold text-white mb-8 tracking-tight">
              Project Zomboid <span className="text-[#c41e3a] relative">
                Servers
                <span className="absolute -bottom-2 left-0 w-full h-1 bg-[#c41e3a]/30 rounded-full"></span>
              </span>
            </h1>
            <p className="text-gray-100 text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">
              High-performance Project Zomboid servers with instant setup, mod support, and automated backups.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-24 bg-[#000000] relative overflow-hidden">
        ...
        <div id="pricing-section" className="max-w-7xl mx-auto px-4 relative">
          <Pricing 
            ...
            title={`Project Zomboid Server Plans in ${countryPricing[selectedCountry as keyof typeof countryPricing].location}`}
            description="Choose the perfect Project Zomboid server for your survival community. All plans include game panel access, DDoS protection, and mod support."
          />
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="relative overflow-hidden">
            ...
            <div className="relative aspect-[21/9] rounded-3xl overflow-hidden group">
              ...
              >
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#c41e3a] transition-all duration-300">
                  <img 
                    src="/images/projectzomboid.jpg" 
                    alt="Project Zomboid Server Screenshot 1"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#c41e3a] transition-all duration-300">
                  <img 
                    src="/images/projectzomboid1.jpg" 
                    alt="Project Zomboid Server Screenshot 2"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#c41e3a] transition-all duration-300">
                  <img 
                    src="/images/projectzomboid2.jpg" 
                    alt="Project Zomboid Server Screenshot 3"
                    className="w-full h-full object-cover"
                  />
                </div>
              </div>
              ...
              <div className="absolute bottom-4 left-4 bg-black/50 px-3 py-1 rounded-full">
                <p className="text-sm text-white/90">PHOTOS: PROJECTZOMBOID.COM</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                answer: "Our Project Zomboid servers are hosted in multiple locations including the United States (Ashburn, VA), United Kingdom, Turkey, and Poland. Choose the location closest to your survivors for the best performance."
              },
              {
              ...
              {
                question: "How do I manage my Project Zomboid server?",
              ...
              <div key={index} className="bg-black border border-[#1a1d26] rounded-2xl overflow-hidden">
                ...
                >
                  <h3 className="text-xl font-semibold text-[#c41e3a]">{faq.question}</h3>
                  <svg 
                    className={`w-6 h-6 text-[#c41e3a] transform transition-transform duration-300 ${openQuestion === index ? 'rotate-180' : ''}`} 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                  >
                ...
                >
                  <div className="border border-[#c41e3a]/20 rounded-xl bg-[#c41e3a]/5 p-4">
                    <p className="text-[#c41e3a]/90">{faq.answer}</p>
                  </div>
                </div>
              </div>
            ))}
