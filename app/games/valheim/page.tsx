    ...
    return [
      {
        ...
        description: "Perfect for small Viking clans up to 10 players",
      ...
      },
      {
        ...
        description: "For large Viking alliances with 64+ players",
        buttonText: "Deploy Now",
        href: "/deploy",
        isPopular: false,
      }
  ...
  const CountrySelector = () => (
    <div className="max-w-7xl mx-auto px-4 mb-16">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-400 text-lg">Choose the datacenter closest to your Vikings for optimal performance</p>
      </div>
              ...
              className={`relative group p-6 rounded-xl border-2 transition-all duration-300 min-w-[200px] ${
                isOutOfStock 
                  ...
                  : selectedCountry === code
                    ? 'border-[#4b6584] bg-[#4b6584]/10'
                    : 'border-gray-800 hover:border-[#4b6584]/50 hover:bg-[#4b6584]/5'
              }`}
            >
              <div className="flex flex-col items-center">
                ...
                {selectedCountry === code && !isOutOfStock && (
                  <div className="absolute -top-3 -right-3">
                    <div className="w-6 h-6 bg-[#4b6584] rounded-full flex items-center justify-center">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-[#1a1d26] to-[#0f1117] pt-32 pb-20 min-h-[800px]">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute inset-0 w-full h-full">
            <iframe
              src="https://www.youtube.com/embed/5mHRJ1KFe20?autoplay=1&mute=1&controls=0&loop=1&playlist=5mHRJ1KFe20&showinfo=0&modestbranding=1&rel=0"
        ...
        <div className="relative max-w-6xl mx-auto text-center px-4 z-20 mt-12">
          <div className="animate-fade-in-up backdrop-blur-sm bg-black/10 p-12 rounded-3xl">
            <h1 className="text-7xl font-bold text-white mb-8 tracking-tight">
              Valheim <span className="text-[#4b6584] relative">
                Servers
                <span className="absolute -bottom-2 left-0 w-full h-1 bg-[#4b6584]/30 rounded-full"></span>
              </span>
            </h1>
            <p className="text-gray-100 text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">
              High-performance Valheim servers with instant setup, mod support, and automated backups.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-24 bg-[#000000] relative overflow-hidden">
        ...
        <div id="pricing-section" className="max-w-7xl mx-auto px-4 relative">
          <Pricing 
            ...
            title={`Valheim Server Plans in ${countryPricing[selectedCountry as keyof typeof countryPricing].location}`}
            description="Choose the perfect Valheim server for your Viking clan. All plans include game panel access, DDoS protection, and mod support."
          />
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="relative overflow-hidden">
            ...
            <div className="relative aspect-[21/9] rounded-3xl overflow-hidden group">
              ...
              >
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#4b6584] transition-all duration-300">
                  <img 
                    src="/images/valheim.jpg" 
                    alt="Valheim Server Screenshot 1"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#4b6584] transition-all duration-300">
                  <img 
                    src="/images/valheim1.jpg" 
                    alt="Valheim Server Screenshot 2"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#4b6584] transition-all duration-300">
                  <img 
                    src="/images/valheim2.jpg" 
                    alt="Valheim Server Screenshot 3"
                    className="w-full h-full object-cover"
                  />
                </div>
              </div>
              ...
              <div className="absolute bottom-4 left-4 bg-black/50 px-3 py-1 rounded-full">
                <p className="text-sm text-white/90">PHOTOS: VALHEIM.GAME</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                answer: "Our Valheim servers are hosted in multiple locations including the United States (Ashburn, VA), United Kingdom, Turkey, and Poland. Choose the location closest to your Vikings for the best performance."
              },
              {
              ...
              {
                question: "How do I manage my Valheim server?",
              ...
              <div key={index} className="bg-black border border-[#1a1d26] rounded-2xl overflow-hidden">
                ...
                >
                  <h3 className="text-xl font-semibold text-[#4b6584]">{faq.question}</h3>
                  <svg 
                    className={`w-6 h-6 text-[#4b6584] transform transition-transform duration-300 ${openQuestion === index ? 'rotate-180' : ''}`} 
                    fill="none" 
                    stroke="currentColor" 
                    viewBox="0 0 24 24"
                  >
                ...
                >
                  <div className="border border-[#4b6584]/20 rounded-xl bg-[#4b6584]/5 p-4">
                    <p className="text-[#4b6584]/90">{faq.answer}</p>
                  </div>
                </div>
              </div>
            ))}
