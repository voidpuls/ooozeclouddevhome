  ...
  const CountrySelector = () => (
    <div className="max-w-7xl mx-auto px-4 mb-16">
      <div className="text-center mb-12">
        ...
        <p className="text-gray-400 text-lg">Choose the datacenter closest to your Pals for optimal performance</p>
      </div>
              ...
              className={`relative group p-6 rounded-xl border-2 transition-all duration-300 min-w-[200px] ${
                isOutOfStock 
                  ...
                  : selectedCountry === code
                    ...
                    : 'border-gray-800 hover:border-[#00d1ff]/50 hover:bg-[#00d1ff]/5'
              }`}
            >
              <div className="flex flex-col items-center">
                ...
                {selectedCountry === code && !isOutOfStock && (
                  <div className="absolute -top-3 -right-3">
                    <div className="w-6 h-6 bg-[#00d1ff] rounded-full flex items-center justify-center">
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-[#1a1d26] to-[#0f1117] pt-32 pb-20 min-h-[800px]">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute inset-0 w-full h-full">
            <iframe
              src="https://www.youtube.com/embed/Ipy3ZazeEVg?autoplay=1&mute=1&controls=0&loop=1&playlist=Ipy3ZazeEVg&showinfo=0&modestbranding=1&rel=0"
        ...
        <div className="relative max-w-6xl mx-auto text-center px-4 z-20 mt-12">
          <div className="animate-fade-in-up backdrop-blur-sm bg-black/10 p-12 rounded-3xl">
            <h1 className="text-7xl font-bold text-white mb-8 tracking-tight">
              Palworld <span className="text-[#00d1ff] relative">
                Servers
                <span className="absolute -bottom-2 left-0 w-full h-1 bg-[#00d1ff]/30 rounded-full"></span>
              </span>
            </h1>
            <p className="text-gray-100 text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">
              High-performance Palworld servers with instant setup, mod support, and automated backups.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-24 bg-[#000000] relative overflow-hidden">
        ...
        <div id="pricing-section" className="max-w-7xl mx-auto px-4 relative">
          <Pricing 
            ...
            title={`Palworld Server Plans in ${countryPricing[selectedCountry as keyof typeof countryPricing].location}`}
            description="Choose the perfect Palworld server for your community. All plans include game panel access, DDoS protection, and mod support."
          />
        </div>
      </div>
            ...
            <div className="relative aspect-[21/9] rounded-3xl overflow-hidden group">
              ...
              >
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#FFB800] transition-all duration-300">
                  <img 
                    src="/images/palworld.jpg" 
                    alt="Palworld Server Screenshot 1"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#FFB800] transition-all duration-300">
                  <img 
                    src="/images/palworld1.jpg" 
                    alt="Palworld Server Screenshot 2"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#FFB800] transition-all duration-300">
                  <img 
                    src="/images/palworld2.jpg" 
                    alt="Palworld Server Screenshot 3"
                    className="w-full h-full object-cover"
                  />
                </div>
              </div>
              ...
              <div className="absolute bottom-4 left-4 bg-black/50 px-3 py-1 rounded-full">
                <p className="text-sm text-white/90">PHOTOS: PALWORLD.GAME</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                answer: "Our Palworld servers are hosted in multiple locations including the United States (Ashburn, VA), United Kingdom, Turkey, and Poland. Choose the location closest to your Pals for the best performance."
              },
              {
              ...
              {
                question: "How do I manage my Palworld server?",
