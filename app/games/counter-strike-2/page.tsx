        ...
        <div className="relative h-[40vh] overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            <div className="container mx-auto">
              <h1 className="text-4xl md:text-6xl font-bold mb-4">Counter-Strike 2</h1>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-black/50 border border-white/10 rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  Professional CS2 servers with advanced anti-cheat and competitive features. Experience the next generation of Counter-Strike with high-performance servers optimized for competitive play.
                </p>
              </div>
              ...
              <div className="bg-black/50 border border-white/10 rounded-xl p-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-300">
                      <li>• CPU: Intel Core i7 or better</li>
                      <li>• RAM: 16GB</li>
              ...
              <div className="sticky top-8 space-y-6">
                <div className="bg-black/50 border border-white/10 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    {[
                      { name: "Basic", price: "12.99", slots: 12 },
                      { name: "Standard", price: "24.99", slots: 24 },
                      { name: "Premium", price: "39.99", slots: 32 }
                    ].map((plan, index) => (
