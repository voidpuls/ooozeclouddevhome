    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="relative">
        ...
        <div className="relative h-[40vh] overflow-hidden">
          <Image
            src="https://cdn.cloudflare.steamstatic.com/steam/apps/105600/header.jpg"
            alt="Terraria"
            fill
          ...
          <div className="absolute bottom-0 left-0 right-0 p-8">
            <div className="container mx-auto">
              <h1 className="text-4xl md:text-6xl font-bold mb-4">Terraria</h1>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-black/50 border border-white/10 rounded-xl p-6">
                ...
                <p className="text-gray-300">
                  Terraria servers with automatic world backups and mod support. Experience the ultimate sandbox adventure with reliable servers and extensive modding capabilities.
                </p>
              </div>
              ...
              <div className="sticky top-8 space-y-6">
                <div className="bg-black/50 border border-white/10 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    {[
                      { name: "Basic", price: "7.99", slots: 8 },
                      { name: "Standard", price: "14.99", slots: 16 },
                      { name: "Premium", price: "24.99", slots: 32 }
                    ].map((plan, index) => (
