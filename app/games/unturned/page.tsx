...
export default function Unturned() {
              ...
              className={`relative group p-6 rounded-xl border-2 transition-all duration-300 min-w-[200px] ${
                isOutOfStock 
                  ...
                  : selectedCountry === code
                    ...
                    : 'border-gray-800 hover:border-[#ffd700]/50 hover:bg-[#ffd700]/5'
              }`}
            >
      ...
      <div className="relative overflow-hidden bg-gradient-to-b from-[#1a1d26] to-[#0f1117] pt-32 pb-20 min-h-[800px]">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute inset-0 w-full h-full">
            <iframe
              src="https://www.youtube.com/embed/R9g6tIs2ZGM?autoplay=1&mute=1&vq=hd1080&controls=0&loop=1&playlist=R9g6tIs2ZGM&showinfo=0&modestbranding=1&rel=0"
        ...
        <div className="relative max-w-6xl mx-auto text-center px-4 z-20 mt-12">
          <div className="animate-fade-in-up backdrop-blur-sm bg-black/10 p-12 rounded-3xl">
            <h1 className="text-7xl font-bold text-white mb-8 tracking-tight">
              Unturned <span className="text-[#ffd700] relative">
                Servers
                <span className="absolute -bottom-2 left-0 w-full h-1 bg-[#ffd700]/30 rounded-full"></span>
              </span>
            </h1>
            <p className="text-gray-100 text-2xl mb-12 max-w-3xl mx-auto leading-relaxed">
              High-performance Unturned servers with instant setup, workshop support, and automated backups.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-24 bg-[#000000] relative overflow-hidden">
        ...
        <div id="pricing-section" className="max-w-7xl mx-auto px-4 relative">
          <Pricing 
            ...
            title={`Unturned Server Plans in ${countryPricing[selectedCountry as keyof typeof countryPricing].location}`}
            description="Choose the perfect Unturned server for your community. All plans include game panel access, DDoS protection, and workshop support."
          />
        </div>
      </div>
            ...
            <div className="relative aspect-[21/9] rounded-3xl overflow-hidden group">
              ...
              >
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#FFB800] transition-all duration-300">
                  <img 
                    src="/images/unturned.jpg" 
                    alt="Unturned Server Screenshot 1"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#FFB800] transition-all duration-300">
                  <img 
                    src="/images/unturned1.jpg" 
                    alt="Unturned Server Screenshot 2"
                    className="w-full h-full object-cover"
                  />
                </div>
                <div className="min-w-full h-full relative group-hover:ring-4 group-hover:ring-[#FFB800] transition-all duration-300">
                  <img 
                    src="/images/unturned2.jpg" 
                    alt="Unturned Server Screenshot 3"
                    className="w-full h-full object-cover"
                  />
                </div>
              </div>
              ...
              <div className="absolute bottom-4 left-4 bg-black/50 px-3 py-1 rounded-full">
                <p className="text-sm text-white/90">PHOTOS: SMARTLYDRESSED.COM</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {[
              {
                ...
                answer: "Our Unturned servers are hosted in multiple locations including the United States (Ashburn, VA), United Kingdom, Turkey, and Poland. Choose the location closest to your survivors for the best performance."
              },
              {
                question: "Can I install custom workshop items?",
                answer: "Yes! All our plans support custom workshop items and mods. Pro and Enterprise plans include one-click workshop installations and automatic updates. You can easily manage your content through our game panel."
              },
              {
              ...
              {
                question: "How do I manage my Unturned server?",
                answer: "Our custom game panel makes server management easy. You can start/stop your server, change settings, install workshop items, manage players, and view real-time performance metrics. No technical knowledge required!"
              }
            ].map((faq, index) => (
