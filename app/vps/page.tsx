...
const features = [
  ...
  },
  {
    ...
    icon: <Globe className="w-6 h-6 text-[#28a745]" />,
    value: "4 Lokasyon"
  },
  {
    title: "Yedekleme",
  ...
  },
  {
    ...
    icon: <Server className="w-6 h-6 text-[#28a745]" />,
    value: "60 Saniye"
  }
];
              ...
              <div className="flex flex-col items-center">
                ...
                {selectedCountry === code && (
                  <div className="absolute -top-2 -right-2 md:-top-3 md:-right-3">
                    <div className="w-5 h-5 md:w-6 md:h-6 bg-[#28a745] rounded-full flex items-center justify-center">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-4xl lg:text-7xl font-bold mb-6 tracking-tight leading-none">
                ...
                <span className="relative">
                  <span className="relative z-10 text-[#28a745]"> NVMe SSD</span>
