...
const features = [
  ...
  },
  {
    ...
    icon: <HardDrive className="w-6 h-6 text-[#fbbf24]" />,
    value: "2TB"
  },
  {
    title: "Network",
    ...
    icon: <Network className="w-6 h-6 text-[#fbbf24]" />,
    value: "10 Gbps"
  },
  {
    title: "Altyapı",
    ...
    icon: <Globe className="w-6 h-6 text-[#fbbf24]" />,
    value: "4 Lokasyon"
  },
  {
    title: "Yedekleme",
    ...
    icon: <Clock className="w-6 h-6 text-[#fbbf24]" />,
    value: "30 Gün"
  },
  {
    title: "Kurulum",
    ...
    icon: <Server className="w-6 h-6 text-[#fbbf24]" />,
    value: "60 Saniye"
  }
];
              ...
              <div className="flex flex-col items-center">
                ...
                {selectedCountry === code && (
                  <div className="absolute -top-2 -right-2 md:-top-3 md:-right-3">
                    <div className="w-5 h-5 md:w-6 md:h-6 bg-[#fbbf24] rounded-full flex items-center justify-center">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-4xl lg:text-7xl font-bold mb-6 tracking-tight leading-none">
                ...
                <span className="relative">
                  <span className="relative z-10 text-[#fbbf24]"> NVMe SSD</span>
                        ...
                        <div className="mt-4 space-y-3">
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between text-sm">
                              ...
                              <span className="text-[#fbbf24]">{metrics.memory}%</span>
                            </div>
                            <div className="h-1.5 bg-gray-800 rounded-full overflow-hidden">
                              <div 
                                className="h-full bg-[#fbbf24] rounded-full transition-all duration-500"
                          ...
                          <div className="space-y-2">
                            <div className="flex justify-between text-sm">
                              ...
                              <span className="text-[#fbbf24]">{metrics.network} Mbps</span>
                            </div>
                            <div className="h-1.5 bg-gray-800 rounded-full overflow-hidden">
                              <div 
                                className="h-full bg-[#fbbf24] rounded-full transition-all duration-500"
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="flex space-x-6 animate-scroll">
                  {[...operatingSystems, ...operatingSystems, ...operatingSystems].map((os, index) => (
                    <div
                      key={`${os.name}-${index}`}
                      className="flex-none w-44 bg-[#1a1d26] p-4 rounded-xl border border-gray-800 hover:border-[#fbbf24] transition-colors group"
                    >
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="bg-black border border-[#1a1d26] rounded-2xl overflow-hidden">
                    ...
                    >
                      <h3 className="text-xl font-semibold text-[#fbbf24]">{faq.question}</h3>
                      <svg 
                        className={`w-6 h-6 text-[#fbbf24] transform transition-transform duration-300 ${openFaq === index ? 'rotate-180' : ''}`} 
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                      >
                    ...
                    >
                      <div className="border border-[#fbbf24]/20 rounded-xl bg-[#fbbf24]/5 p-4">
                        <p className="text-[#fbbf24]/90">{faq.answer}</p>
                      </div>
                    </div>
                  </div>
                ))}
