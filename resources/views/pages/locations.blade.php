...
<div class="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 pt-24">
    ...
    <div class="fixed inset-0 -z-10">
        ...
        <div class="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#28a745]/50 to-transparent"></div>
        <div class="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#28a745]/50 to-transparent"></div>
    </div>
        ...
        <div class="relative">
            ...
            <div class="absolute flex items-center justify-center"
                ...
                <div class="relative flex flex-col items-center"
                    ...
                    {{-- Location Point --}}
                    <div class="relative">
                        <div class="w-1.5 h-1.5 bg-[#28a745] rounded-sm transform rotate-45 border border-[#28a745]"></div>
                    </div>

                    {{-- Ping Info --}}
                    <div class="mt-2 bg-[#0B0E14]/90 backdrop-blur-sm rounded-full px-3 py-1 border border-[#28a745]/10">
