...
import { Search, Bot, Zap, Users, Shield, CheckCircle, Star, Rocket, MessageCircle, Globe } from 'lucide-react';

// This component displays a single Discord bot hosting card.
const DiscordBotCard = ({ title, description, price, imageSrc, features, isPopular = false, tag = null, rating, orderLink }) => {
    return (
        <div className="relative p-6 bg-[#1a1b2b] rounded-3xl shadow-2xl border-2 border-transparent transition-all duration-500 hover:border-purple-600 transform hover:-translate-y-2 cursor-pointer flex flex-col">
            ...
            <div className="flex justify-center items-center h-32 mb-4">
                <img
                    ...
                    onError={(e) => e.target.src = "https://placehold.co/300x150/d24dff/ffffff?text=Discord+Bot"}
                />
            </div>
            ...
            <div className="flex flex-col space-y-2 text-sm mb-6">
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-300">{features.botType}</span>
                </div>
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-300">{features.serverLimit}</span>
                </div>
                <div className="flex items-center space-x-2">
...
const DiscordPage = () => {
    // Mock data for Discord bot hosting plans
    const discordBotPlans = [
        {
            id: 1,
            title: "SHARED HOSTING",
            description: "Lightweight and reliable bot hosting for basic needs.",
            price: "Rp5,000/month",
            rating: "4.5",
            imageSrc: "https://platform.theverge.com/wp-content/uploads/sites/2/chorus/uploads/chorus_asset/file/19816263/acastro_200318_1777_discord_0001.0.jpg?quality=90&strip=all&crop=0,0,100,100",
            isPopular: false,
        ...
        },
        {
            id: 2,
            title: "BASIC HOSTING",
            description: "Robust performance for bots with moderate needs.",
        ...
        },
        {
            ...
            description: "High-level hosting for busy bots.",
            ...
            <div className="relative z-10 p-4 sm:p-8">
                ...
                <header className="text-center py-12 px-4">
                    ...
                    <p className="text-gray-400 text-lg sm:text-xl font-medium mb-12">
                        Choose the Discord bot hosting plan that best suits your community's needs.
                    </p>
